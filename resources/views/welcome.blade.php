...
@section('content')
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            ...
            <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                <a href="{{ route('form.penyakit') }}"
                    class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-green-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    Mulai Konsultasi
    ...
    <footer class="bg-gradient-to-b from-blue-100 to-white text-dark py-12">
            ...
            <div class="flex flex-wrap justify-between">
                ...
                <div class="w-1/4">
                    ...
                    <div class="flex space-x-4">
                        <a href="https://www.facebook.com/profile.php?id=100014370000991" class="text-blue-600 hover:text-blue">
                        ...
                        <a href="https://rsudps.bantulkab.go.id/" class="text-blue-500 hover:text-blue">
                        ...
                        <a href="https://www.youtube.com/channel/UCRN0TXo9pJsVfY41nWHRpAA" class="text-red-600 hover:text-red">
