...
@section('content')
    <section
        class="bg-gradient-to-b from-blue-100 to-white dark:bg-gray-900 p-5 flex items-center justify-center min-h-screen">
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden w-full max-w-6xl mt-20">
            <div class="p-5">
                ...
                @if ($penyakitTerbesar && count($penyakitTerbesar) > 0)
                        ...
                        <div class="flex flex-col md:flex-row mb-5">
                            <div class="md:w-1/3 mx-auto mb-3 md:mb-0 text-center">
                                <img src="{{ asset('storage/' . $penyakit['gambar']) }}" alt="{{ $penyakit['nama'] }}"
                                    class="mb-3 max-h-150px mx-auto">
                            </div>
                            <div class="md:w-2/3">
                    ...
                    @endforeach
                @else
                    <p class="text-center text-xl text-gray-700 dark:text-gray-300">Tidak ada penyakit yang teridentifikasi
            ...
            <div class="flex justify-end p-5">
                <a href="{{ route('diagnosa.cetak') }}"
                    class="bg-green-600 hover:bg-green-800 text-white font-bold py-2 px-4 rounded mr-2">
                    <i class="bi bi-printer-fill"></i> Cetak PDF
                </a>
                <a href="/form-diagnosa"
                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">Diagnosa Ulang</a>
